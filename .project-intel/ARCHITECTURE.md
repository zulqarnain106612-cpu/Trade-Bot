...
> Auto-generated 2026-04-15 23:33 | 832 Python modules | 240,580 total lines
...
### `src/data/storage.py` (1556 lines)
...
**Classes**: MultiProviderIntelligenceAggregator
**Key functions**: get_m
...
### `tests/test_orchestrator_coverage.py` (456 lines)
**Purpose**: Comprehensive coverage tests for src/engine/orchestrator.py.

Coverage target: 1
**Classes**: TestOrchestratorInit, TestOrchestratorStartup, TestOrchestratorStopShutdown, TestOrchestratorTick, TestOrchestratorTrainModels
