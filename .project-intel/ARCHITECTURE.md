...
> Auto-generated 2026-06-29 09:24 | 808 Python modules | 232,629 total lines
...
### `src/engine/signal_engine.py` (618 lines)
...
### `src/intelligence/causal_inference.py` (374 lines)
...
### `src/intelligence/ensemble_predictor.py` (350 lines)
...
### `tests/test_signal_engine.py` (369 lines)
**Purpose**: Test coverage for src/engine/signal_engine.py — Debt-005.

Strategy: mock all ex
**Classes**: TestSkipShape, TestSkipPaths, TestTradeablePath, TestModelSwap
