...
import { withTempDirectoryIn, getHostArch, getNodeArch, ensureIsTruthyString, isOfficialDropped32BitDownload, isOfficialLinuxIA32Download, mkdtemp, doesCallerOwnTemporaryOutput, effectiveCacheMode, shouldTryReadCache, TempDirCleanUpMode, } from './utils.js';
...
export async function downloadArtifact(artifactDetails) {
    ...
    if (!details.isGeneric &&
        isOfficialDropped32BitDownload(details.platform, details.arch, details.version, details.mirrorOptions)) {
        throw new Error(`Electron ${details.version} does not have a published ${details.platform}/${details.arch} artifact. ` +
