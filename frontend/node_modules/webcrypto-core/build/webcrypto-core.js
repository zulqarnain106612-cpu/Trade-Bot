...
var legacy = require('@peculiar/utils/legacy');
...
var bytes__namespace = /*#__PURE__*/_interopNamespaceDefault(bytes);
...
class PemConverter {
    static toArrayBuffer(pem) {
        const base64 = pem
            ...
            .replace("\r", "")
            .replace("\n", "");
        return bytes__namespace.toArrayBuffer(encoding__namespace.base64.decode(base64));
    }
    ...
    static fromBufferSource(buffer, tag) {
        const base64 = encoding__namespace.base64.encode(buffer);
        let sliced;
        let offset = 0;
        const rows = [];
...
class ProviderCrypto {
    ...
    checkKeyData(format, keyData) {
        ...
        else if (!bytes__namespace.isBufferSource(keyData)) {
            throw new TypeError("keyData: Is not ArrayBufferView or ArrayBuffer");
        }
    }
    prepareData(data) {
        return bytes__namespace.toArrayBuffer(data);
    }
}
...
class RsaProvider extends ProviderCrypto {
    ...
    checkGenerateKeyParams(algorithm) {
        ...
        const publicExponent = encoding__namespace.base64url.encode(algorithm.publicExponent);
...
tslib.__decorate([
    asn1Schema.AsnProp({
        type: asn1Schema.AsnPropTypes.Any, optional: true,
    })
...
const JsonBase64UrlArrayBufferConverter = {
    fromJSON: (value) => bytes__namespace.toArrayBuffer(encoding__namespace.base64url.decode(value)),
    toJSON: (value) => encoding__namespace.base64url.encode(value),
};
...
const AsnIntegerArrayBufferConverter = {
    ...
    toASN: (value) => {
        const valueHex = new Uint8Array(value)[0] > 127
            ? bytes__namespace.concat(new Uint8Array([0]).buffer, value)
            : value;
...
tslib.__decorate([
    asn1Schema.AsnProp({
        type: asn1Schema.AsnPropTypes.Integer, converter: asn1Schema.AsnIntegerConverter,
    })
], RsaPrivateKey.prototype, "version", void 0);
tslib.__decorate([
    asn1Schema.AsnProp({
        type: asn1Schema.AsnPropTypes.Integer, converter: AsnIntegerArrayBufferConverter,
    }),
    jsonSchema.JsonProp({
...
let EcPublicKey = class EcPublicKey {
    ...
    toJSON() {
        ...
        const offset = 0;
        const json = {
            x: encoding__namespace.base64url.encode(bytes.buffer.slice(offset, offset + size)),
            y: encoding__namespace.base64url.encode(bytes.buffer.slice(offset + size, offset + size + size)),
        };
        return json;
    }
    fromJSON(json) {
        ...
        const x = encoding__namespace.base64url.decode(json.x);
        const y = encoding__namespace.base64url.decode(json.y);
        const value = bytes__namespace.concat(new Uint8Array([0x04]).buffer, x, y);
        this.value = bytes__namespace.toArrayBuffer(value);
        return this;
    }
};
tslib.__decorate([
...
class EcPrivateKey {
    ...
    fromJSON(json) {
        ...
        this.privateKey = bytes__namespace.toArrayBuffer(encoding__namespace.base64url.decode(json.d));
        if ("x" in json) {
    ...
    toJSON() {
        const jwk = {};
        jwk.d = encoding__namespace.base64url.encode(this.privateKey);
        if (this.publicKey) {
...
tslib.__decorate([
    asn1Schema.AsnProp({
        context: 0, type: asn1Schema.AsnPropTypes.Any, optional: true,
    })
], EcPrivateKey.prototype, "parameters", void 0);
tslib.__decorate([
    asn1Schema.AsnProp({
        context: 1, type: asn1Schema.AsnPropTypes.BitString, optional: true,
    })
], EcPrivateKey.prototype, "publicKey", void 0);

class EcUtils {
    static decodePoint(data, pointSize) {
        const view = bytes__namespace.toUint8Array(data);
    ...
    static encodePoint(point, pointSize) {
        ...
        const x = bytes__namespace.toUint8Array(point.x);
        const y = bytes__namespace.toUint8Array(point.y);
    ...
    static encodeSignature(signature, pointSize) {
        ...
        const r = bytes__namespace.toUint8Array(signature.r);
        const s = bytes__namespace.toUint8Array(signature.s);
    ...
    static decodeSignature(data, pointSize) {
        ...
        return {
            r: bytes__namespace.toArrayBuffer(this.trimStart(r)),
            s: bytes__namespace.toArrayBuffer(this.trimStart(s)),
        };
    }
...
class EcDsaSignature {
    static fromWebCryptoSignature(value) {
        ...
        ecSignature.r = bytes__namespace.toArrayBuffer(point.r);
        ecSignature.s = bytes__namespace.toArrayBuffer(point.s);
        return ecSignature;
    }
    r = new ArrayBuffer(0);
    s = new ArrayBuffer(0);
    toWebCryptoSignature(pointSize) {
        ...
        return bytes__namespace.toArrayBuffer(signature);
    }
}
tslib.__decorate([
    asn1Schema.AsnProp({
        type: asn1Schema.AsnPropTypes.Integer, converter: AsnIntegerWithoutPaddingConverter,
    })
...
tslib.__decorate([
    asn1Schema.AsnProp({
        context: 1, implicit: true, type: asn1Schema.AsnPropTypes.BitString, optional: true,
    })
...
let EdPrivateKey = class EdPrivateKey {
    ...
    fromJSON(json) {
        ...
        this.value = bytes__namespace.toArrayBuffer(encoding__namespace.base64url.decode(json.d));
        return this;
    }
    toJSON() {
        const jwk = { d: encoding__namespace.base64url.encode(this.value) };
        return jwk;
    }
};
tslib.__decorate([
...
let EdPublicKey = class EdPublicKey {
    ...
    toJSON() {
        const json = { x: encoding__namespace.base64url.encode(this.value) };
        return json;
    }
    fromJSON(json) {
        if (!("x" in json)) {
        ...
        this.value = bytes__namespace.toArrayBuffer(encoding__namespace.base64url.decode(json.x));
        return this;
    }
};
tslib.__decorate([
...
tslib.__decorate([
    asn1Schema.AsnProp({ type: asn1Schema.AsnPropTypes.OctetString }),
    jsonSchema.JsonProp({
        type: jsonSchema.JsonPropTypes.String, converter: JsonBase64UrlArrayBufferConverter,
    })
...
class HkdfProvider extends ProviderCrypto {
    ...
    checkAlgorithmParams(algorithm) {
        ...
        this.checkHashAlgorithm(algorithm.hash, this.hashAlgorithms);
        this.checkRequiredProperty(algorithm, "salt");
        if (!bytes__namespace.isBufferSource(algorithm.salt)) {
            throw new TypeError("salt: Is not of type '(ArrayBuffer or ArrayBufferView)'");
        }
        this.checkRequiredProperty(algorithm, "info");
        if (!bytes__namespace.isBufferSource(algorithm.info)) {
...
class Crypto {
    ...
    randomUUID() {
        ...
        b[6] = (b[6] & 0x0f) | 0x40;
        b[8] = (b[8] & 0x3f) | 0x80;
        const uuid = encoding__namespace.hex.encode(b, { case: "lower" });
...
class SubtleCrypto {
    ...
    async digest(...args) {
        ...
        const preparedData = bytes__namespace.toArrayBuffer(data);
    ...
    async verify(...args) {
        ...
        const preparedAlgorithm = this.prepareAlgorithm(algorithm);
        const preparedData = bytes__namespace.toArrayBuffer(data);
        const preparedSignature = bytes__namespace.toArrayBuffer(signature);
        const provider = this.getProvider(preparedAlgorithm.name);
    ...
    async importKey(...args) {
        ...
        if (format === "jwk") {
            ...
            if (!bytes__namespace.isBufferSource(keyData)) {
    ...
    async wrapKey(format, key, wrappingKey, wrapAlgorithm, ...args) {
        ...
        if (format === "jwk") {
            ...
            keyData = bytes__namespace.toArrayBuffer(encoding__namespace.utf8.encode(json));
        }
        const preparedAlgorithm = this.prepareAlgorithm(wrapAlgorithm);
        const preparedData = bytes__namespace.toArrayBuffer(keyData);
        const provider = this.getProvider(preparedAlgorithm.name);
    ...
    async unwrapKey(format, wrappedKey, unwrappingKey, unwrapAlgorithm, unwrappedKeyAlgorithm, extractable, keyUsages, ...args) {
        ...
        const preparedData = bytes__namespace.toArrayBuffer(wrappedKey);
        const provider = this.getProvider(preparedAlgorithm.name);
        ...
        if (format === "jwk") {
            try {
                keyData = JSON.parse(encoding__namespace.utf8.decode(keyData));
            }
            catch (e) {
...
class JwkUtils {
    static async thumbprint(hash, jwk, crypto) {
        ...
        return crypto.subtle.digest(hash, bytes__namespace.toArrayBuffer(encoding__namespace.binary.decode(JSON.stringify(data))));
    }
...
Object.defineProperty(exports, "BufferSourceConverter", {
    enumerable: true,
    get: function () { return legacy.BufferSourceConverter; }
});
