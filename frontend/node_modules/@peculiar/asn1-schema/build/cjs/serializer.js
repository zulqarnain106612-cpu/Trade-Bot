...
const utils_1 = require("@peculiar/utils");
        ...
        if (schema.itemType) {
            ...
            for (const key in schema.items) {
                ...
                if (objProp === undefined ||
                    ...
                    (typeof schemaItem.defaultValue === "object" && typeof objProp === "object" && (0, helper_1.isArrayEqual)(this.serialize(schemaItem.defaultValue), this.serialize(objProp)))) {
                    continue;
                }
